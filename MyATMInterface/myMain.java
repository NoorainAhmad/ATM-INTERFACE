...
public class myMain {
    public static void main(String[] args){
        ...
        System.out.println("Welcome to XYZ Bank ATM! Please enter your ATM Number: ");
        ...
        if(myatmNum==atmNumber && atmPin==atmPassword){
            ...
            while(true){
                ...
                if(option==1){
                    ...
                    System.out.println("Thank You for choosing XYZ Bank ATM! Please collect your card.");
                    System.exit(0);
                }
                else{
